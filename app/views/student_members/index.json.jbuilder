...
json.data do
  json.array!(@student_members) do |student_member|
    json.extract!(student_member, :id, :first_name, :last_name, :member_title, :class_year, :email, :expected_graduation_date, :social_point_amount, :meeting_point_amount, :fundraiser_point_amount, :informational_point_amount)
